...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this manage branch? Once deleted, it cannot be restored.",
  },
  success: {
    title: "Manage branch Deleted",
  },
};
...
export function RowActions({ row, table }) {
  const navigate = useNavigate(); // 👈 Hook
   const handleEdit = () => {
    ...
    navigate(`/dashboards/hrm/manage-branch/edit/${id}`);
  };
