// GenerateUlr.jsx
// PHP equivalent: ulrrequest.php
// Route: /dashboards/action-items/generate-ulr/:id?hid=
//
// APIs:
//   GET  /actionitem/get-generate-ulr-data?id={tid}&hid={hid}
//   POST /actionitem/generate-ulr
//
// Actual API response fields:
//   product               → product name string
//   package               → package name string
//   button_label          → "Generate ULR" / "Complete Report"
//   has_pending_parameters → PHP: $parameter (partial results warning)
//   paymentpass           → PHP: $paymentpass
//   pass2                 → PHP: $pass2
//   pending_request_count → PHP: $pendingreuest
//   can_generate_button   → PHP: in_array(137,$permissions)
//   show_date_field       → PHP: in_array(462,$permissions)
//   signatories           → array of { id, name }
...
export default function GenerateUlr() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
        pageData?.button_label === "Generate ULR"
