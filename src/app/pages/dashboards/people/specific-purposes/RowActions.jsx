...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this specific-purposes? Once deleted, it cannot be restored.",
  },
  success: {
    title: "specific-purposes Deleted",
  },
};
...
export function RowActions({ row, table }) {
    const navigate = useNavigate(); // 👈 Hook
     const handleEdit = () => {
      ...
      navigate(`/dashboards/people/specific-purposes/edit/${id}`);
  ...
  try {
    await axios.delete(`/people/delete-specific-purpose/${id}`);
