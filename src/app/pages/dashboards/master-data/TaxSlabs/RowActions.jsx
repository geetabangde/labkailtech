...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this Taxslab? Once deleted, it cannot be restored.",
  },
  success: {
    title: "TaxSlab Deleted",
  },
};
...
export function RowActions({ row, table }) {
  ...
  const navigate = useNavigate(); // 👈 Hook
     const handleEdit = () => {
      ...
      navigate(`/dashboards/master-data/tax-slabs/edit/${id}`);
    }; 
  ...
  setConfirmDeleteLoading(true);
    ...
    try {
      await axios.delete(`/master/delete-taxslab/${id}`);
