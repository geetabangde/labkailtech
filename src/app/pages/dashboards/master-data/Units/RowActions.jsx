...
const confirmMessages = {
  pending: {
    description:
      "Are you sure you want to delete this Units? Once deleted, it cannot be restored.",
  },
  success: {
    title: "Units Deleted",
  },
...
export function RowActions({ row, table }) {
   ...
   const handleEdit = () => {
    ...
    navigate(`/dashboards/master-data/units/edit/${id}`);
  };
  ...
  try {
    await axios.delete(`/master/delete-unit/${id}`);
