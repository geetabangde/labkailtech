        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              disabled={isLoading}
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-1 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed ${
                showValidation && !approveDate ? 'border-red-300 bg-red-50 focus:ring-red-500' : 'border-blue-300 bg-white focus:ring-blue-500'
              }`}
            />
